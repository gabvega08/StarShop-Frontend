...
const StoreSettingsPage = () => {
  return (
    ...
    <div className='flex flex-col h-screen pt-10 pl-6 pr-10'>
      <h1 className='text-3xl font-bold text-white mb-8' style={{ textShadow: '0 0 10px rgba(210,204,227, 0.7)' }}>Store Settings</h1>
      <form action="" className="space-y-6 pl-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="storeDescription" className="block text-sm font-medium text-white mb-2">
              Store Description
            </label>
            <textarea
              id="storeDescription"
          ...
          <button type="submit" className="mt-6 rounded-xl bg-purple-500 shadow-[0_0_12px_rgba(70,60,110,1)] px-6 py-3 text-white font-semibold hover:bg-purple-700 bg-opacity-70 transition-colors">
            Save Changes
          </button>
        </div>
      </form>
