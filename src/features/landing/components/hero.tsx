...
import { OppiaLogoIcon } from '@/features/common/landing/icon/OppiaIcon';
    ...
    <section className="p-0 flex flex-col-reverse md:flex-row w-full xl:my-[35px] xl:pl-[100px] px-[10px] md:px-[50px] pb-[100px] text-white max-w-[1600px] m-auto">
      <div className="w-full md:w-1/2 xl:max-w-[700px]">
        ...
        <p className="text-white text-lg sm:text-sm mt-[20px] md:mt-[35px]">
          StarShop enables small businesses to sell products transparently while
          fostering trust. Customers receive unique NFTs as digital collectibles
          with each purchase, and businesses earn milestone NFTs to showcase
          their success.
        </p>
        <Link
          href="/register"
        ...
        <section className="flex flex-col md:flex-row mt-[50px] !text-center">
          <article className="mb-6">
            <div className="text-4xl sm:text-4xl font-semibold md:mb-2">
              200+
            </div>
