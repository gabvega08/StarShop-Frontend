...
export const FLOATING_ELEMENTS = [
  {
    className: "absolute top-1/4 left-1/4 w-2 h-2 bg-purple-400/40 rounded-full animate-pulse"
  },
  {
    className: "absolute top-3/4 right-1/3 w-3 h-3 bg-blue-400/30 rounded-full animate-bounce delay-300"
  },
  {
    className: "absolute top-1/2 right-1/4 w-1.5 h-1.5 bg-teal-400/50 rounded-full animate-ping delay-700"
  }
] as const;
