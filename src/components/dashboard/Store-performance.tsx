...
const salesData = [
    {
      status: "In-progress",
      statusColor: "#3B82F61A", // Light blue background
      textColor: "#60A5FA", // Blue text
    ...
    {
      status: "On Track",
      statusColor: "#34D3991A", // Light green background
      textColor: "#34D399", // Green text
    ...
    },
    {
      ...
      statusColor: "#FACC151A", // Light yellow background
