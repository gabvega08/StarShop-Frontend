    ...
    <div className="flex flex-col items-center space-y-12 rounded-xl min-w-[600px]">
      ...
      <div className="flex space-x-6">
        <button
          ...
          className={`px-6 py-2.5 rounded-full text-white font-medium transition-all duration-300 ${currentStep === 1
        ...
        <button
          ...
          className={`px-6 py-2.5 rounded-full text-white font-medium flex items-center space-x-2 transition-all duration-300 ${currentStep === steps.length
              ? "bg-white/10 text-white/50 cursor-not-allowed"
              : "bg-purple-600 hover:bg-purple-700 shadow-lg shadow-purple-500/25"
            }`}
        >
