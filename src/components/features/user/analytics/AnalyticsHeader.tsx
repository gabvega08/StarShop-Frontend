          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              <button 
                ...
                className="flex items-center justify-between gap-2 px-4 py-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors min-w-[180px]"
              >
            ...
            <div className="relative">
              ...
              {isDatePickerOpen && (
                <div className="absolute top-full right-0 mt-2 p-4 bg-gray-800 rounded-lg shadow-lg z-10">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="px-3 py-2 bg-gray-700 rounded-lg text-white border border-gray-600 focus:outline-none focus:border-purple-500"
                      />
