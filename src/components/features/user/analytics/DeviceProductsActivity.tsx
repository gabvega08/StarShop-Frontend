...
import { ChevronRight, Box, Star, Eye, Smartphone, Monitor, Tablet } from 'lucide-react';
...
const DeviceProductsActivity = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="p-6 rounded-lg border border-white/20 shadow-[0_0_8px_rgba(255,255,255,0.2)] bg-gray-900/50">
