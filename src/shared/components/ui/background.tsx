...
export function Background({
  ...
  const getIntensityOpacity = (base: number) => {
    const multiplier = intensity === "subtle" ? 0.6 : intensity === "vibrant" ? 1.4 : 1;
...
export const starshopBackgrounds = {
  ...
  premium: { variant: "all" as const, intensity: "vibrant" as const, animated: true },
} as const;


export function useBackgroundVariant(initialVariant: keyof typeof starshopBackgrounds = "starfield") {
