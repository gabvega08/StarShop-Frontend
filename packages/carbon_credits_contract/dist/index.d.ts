...
import type { i32, u64 } from '@stellar/stellar-sdk/contract';
...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCS3JJZJFSNYOP4X7JSVJBFRFBJHOSPKRWUPQKW5J3I5UZ3L252YOWZW";
    };
};
...
export interface Client {
     ...
     */
    cast_vote: ({ product_id, vote_type, voter }: {
        product_id: string;
        vote_type: VoteType;
        voter: string;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        create_product: (json: string) => AssembledTransaction<Result<void, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        cast_vote: (json: string) => AssembledTransaction<Result<void, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        get_product_score: (json: string) => AssembledTransaction<number>;
        get_trending_products: (json: string) => AssembledTransaction<string[]>;
    };
}
