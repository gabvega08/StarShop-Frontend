...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CC2RU4MBM2NBA5FJXLAAPC2PL35WMT2RJ2SSH4OHUFXTPACJL7W5PH5G";
    };
};
...
export interface Client {
     ...
     */
    update_metadata: ({ admin, token_id, name, description, attributes }: {
        admin: string;
        token_id: u32;
        name: string;
        description: string;
     ...
     */
    mint_nft: ({ to, name, description, attributes }: {
        to: string;
        name: string;
        description: string;
        attributes: Array<string>;
     ...
     */
    validate_metadata: ({ name, description, attributes }: {
        name: string;
        description: string;
        attributes: Array<string>;
    }, options?: {
     ...
     */
    set_max_supply: ({ admin, max_supply }: {
        admin: string;
        max_supply: u32;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        burn_nft: (json: string) => AssembledTransaction<null>;
        get_owner: (json: string) => AssembledTransaction<string>;
        nft_exists: (json: string) => AssembledTransaction<boolean>;
        update_metadata: (json: string) => AssembledTransaction<null>;
        get_metadata: (json: string) => AssembledTransaction<NFTMetadata>;
        mint_nft: (json: string) => AssembledTransaction<number>;
        validate_metadata: (json: string) => AssembledTransaction<null>;
        set_max_supply: (json: string) => AssembledTransaction<null>;
        get_max_supply: (json: string) => AssembledTransaction<number>;
        get_current_supply: (json: string) => AssembledTransaction<number>;
        initialize: (json: string) => AssembledTransaction<null>;
        verify_admin: (json: string) => AssembledTransaction<null>;
