...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCTR6NODMNIW3LPHK7SHEV7G5AVTMNFVXISCKSP7GDBDMXEVJFYGMS5W";
    };
};
...
export interface Client {
     ...
     */
    create_plan: ({ admin, plan_id, name, duration, price, benefits, version, tier }: {
        admin: string;
        plan_id: string;
        name: Buffer;
        duration: u64;
     ...
     */
    update_plan: ({ admin, plan_id, name, duration, price, benefits, version, tier }: {
        admin: string;
        plan_id: string;
        name: Buffer;
        duration: u64;
     ...
     */
    reset_subscription: ({ admin, target_user, plan_id }: {
        admin: string;
        target_user: string;
        plan_id: string;
    }, options?: {
     ...
     */
    get_feature_usage: ({ user, feature }: {
        user: string;
        feature: string;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        create_plan: (json: string) => AssembledTransaction<null>;
        update_plan: (json: string) => AssembledTransaction<null>;
        disable_plan: (json: string) => AssembledTransaction<null>;
        get_plan: (json: string) => AssembledTransaction<Option<Plan>>;
        subscribe: (json: string) => AssembledTransaction<null>;
        renew: (json: string) => AssembledTransaction<null>;
        is_active_sub: (json: string) => AssembledTransaction<boolean>;
        is_expired_sub: (json: string) => AssembledTransaction<boolean>;
        is_in_grace: (json: string) => AssembledTransaction<boolean>;
        get_state: (json: string) => AssembledTransaction<SubscriptionState>;
        premium_content: (json: string) => AssembledTransaction<string>;
        gold_feature: (json: string) => AssembledTransaction<string>;
        add_user_role: (json: string) => AssembledTransaction<null>;
        reset_subscription: (json: string) => AssembledTransaction<null>;
        get_feature_usage: (json: string) => AssembledTransaction<number>;
        cleanup: (json: string) => AssembledTransaction<boolean>;
    };
}
